...
var _user$project$Main$viewMessage = function (message) {
	var nick = message.system ? '' : A2(_elm_lang$core$Basics_ops['++'], message.username, ': ');
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$classList(
				{
					...
					_1: {
						...
						_0: {
							ctor: '_Tuple2',
							_0: 'system',
							_1: _elm_lang$core$Native_Utils.eq(message.system, true)
						},
						_1: {ctor: '[]'}
					}
				}),
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(nick),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(message.message),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
...
var _user$project$Main$addMessage = _elm_lang$core$Native_Platform.outgoingPort(
	'addMessage',
	function (v) {
		return {username: v.username, message: v.message, system: v.system};
	});
var _user$project$Main$messageSaved = _elm_lang$core$Native_Platform.incomingPort('messageSaved', _elm_lang$core$Json_Decode$string);
					...
					return A2(
						...
						function (system) {
							return _elm_lang$core$Json_Decode$succeed(
								{username: username, message: message, system: system});
						},
						A2(_elm_lang$core$Json_Decode$field, 'system', _elm_lang$core$Json_Decode$bool));
				},
...
var _user$project$Main$Message = F3(
	function (a, b, c) {
		return {username: a, message: b, system: c};
	});
		...
		switch (_p0.ctor) {
			...
			case 'SaveMessage':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$Main$addMessage(
						A3(_user$project$Main$Message, model.username, model.message, false))
				};
			case 'MessageSaved':
				return {
					ctor: '_Tuple2',
			...
			case 'MessageAdded':
				var newMessages = {ctor: '::', _0: _p0._0, _1: model.messages};
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
			...
			default:
				var username_ = _elm_lang$core$String$trim(model.username);
				return (_elm_lang$core$Native_Utils.cmp(
					_elm_lang$core$String$length(username_),
					2) < 0) ? {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{username: username_, showDialog: false}),
					_1: _user$project$Main$addMessage(
						A3(
							_user$project$Main$Message,
							'',
							A2(_elm_lang$core$Basics_ops['++'], username_, ' has joined the chat!'),
							true))
				};
		}
	});
var _user$project$Main$Model = F4(
	function (a, b, c, d) {
		return {username: a, message: b, messages: c, showDialog: d};
	});
var _user$project$Main$Acknowledge = {ctor: 'Acknowledge'};
var _user$project$Main$MessageAdded = function (a) {
	return {ctor: 'MessageAdded', _0: a};
};
var _user$project$Main$MessageSaved = function (a) {
	return {ctor: 'MessageSaved', _0: a};
};
var _user$project$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _user$project$Main$messageSaved(_user$project$Main$MessageSaved),
			_1: {
				ctor: '::',
				_0: _user$project$Main$newMessage(_user$project$Main$MessageAdded),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Main$SaveMessage = {ctor: 'SaveMessage'};
var _user$project$Main$MessageInput = function (a) {
	return {ctor: 'MessageInput', _0: a};
};
var _user$project$Main$viewMessageForm = function (model) {
	return A2(
		_elm_lang$html$Html$form,
		{
			...
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onSubmit(_user$project$Main$SaveMessage),
				_1: {ctor: '[]'}
			}
		},
		{
...
var _user$project$Main$dialogConfig = function (model) {
	return {
		closeMessage: _elm_lang$core$Maybe$Just(_user$project$Main$Acknowledge),
		...
		header: _elm_lang$core$Maybe$Just(
			A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Please choose a nickname.'),
					_1: {ctor: '[]'}
				})),
		body: _elm_lang$core$Maybe$Just(
			_elm_lang$html$Html$text('At least 2 non whitespace characters.')),
			...
			A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onSubmit(_user$project$Main$Acknowledge),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: A2(
								_elm_lang$html$Html$input,
								{
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onInput(_user$project$Main$NameInput),
										_1: {
											ctor: '::',
...
var _user$project$Main$viewDialog = function (model) {
	return _krisajenkins$elm_dialog$Dialog$view(
		model.showDialog ? _elm_lang$core$Maybe$Just(
			_user$project$Main$dialogConfig(model)) : _elm_lang$core$Maybe$Nothing);
};
var _user$project$Main$view = function (model) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_1: {
				ctor: '::',
				_0: _user$project$Main$viewMessageForm(model),
				_1: {
					ctor: '::',
					_0: _user$project$Main$viewMessages(model.messages),
					_1: {
						ctor: '::',
						_0: _user$project$Main$viewDialog(model),
						_1: {ctor: '[]'}
					}
				}
			}
